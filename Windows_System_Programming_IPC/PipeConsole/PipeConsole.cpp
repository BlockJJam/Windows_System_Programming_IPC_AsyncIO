...
VOID CALLBACK Handler_PipeRead(PTP_CALLBACK_INSTANCE pInst, PVOID pCtx, PVOID pov, ULONG ior,
	ULONG_PTR dwTrBytes, PTP_IO ptpIo)
{
...
void _tmain(int argc, _TCHAR* argv[])
{
	...
	try
	{
		...
		pi._pipe = CreateFile
		(
			szPipeName, GENERIC_READ | GENERIC_WRITE, 0, NULL, OPEN_EXISTING, FILE_FLAG_OVERLAPPED, NULL
		);
