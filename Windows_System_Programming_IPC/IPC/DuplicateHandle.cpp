...
void _tmain(void)
{
	...
	(
		GetCurrentProcess(), hEvent, GetCurrentProcess(), &hDupEvent, 0, true, DUPLICATE_SAME_ACCESS
	);
	...
	bIsOK = CreateProcess
	(
		NULL, szRunCmdLine, NULL, NULL, true, NORMAL_PRIORITY_CLASS, NULL, NULL, &si, &pi
	);
